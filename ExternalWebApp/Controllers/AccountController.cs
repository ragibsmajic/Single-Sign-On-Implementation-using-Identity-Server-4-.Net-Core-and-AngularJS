...
using ExternalWebApp.Models.AccountViewModels;
using ExternalWebApp.Services;
using Microsoft.AspNetCore.Http;
using Microsoft.AspNetCore.Authentication.Cookies;

namespace ExternalWebApp.Controllers
{
    [Authorize]
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> ExternalLoginCallback(string returnUrl = null, string remoteError = null)
        {
            ...
            var info = await _signInManager.GetExternalLoginInfoAsync(); //GetExternalInfo();//
            if (info == null)
            {
                return RedirectToAction(nameof(Login));
            }
        ...
        private async Task<ExternalLoginInfo> GetExternalInfo()
        {
